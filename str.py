...
BMI = st.sidebar.number_input("Enter your BMI", max_value=200, value=None)
...
if st.button('PREDICT'):
    if (gender == "") or (age is None) or (cigsPerDay == "") or (BPMeds == "") or (prevalentStroke == "") or \
            (prevalentHypertension == "") or (diabetes == "") or (totalCholesterolLevel is None) or \
